                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <form method="post" action="{{ route('update.reason', $reason->id) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="en_name_input" type="text" name="en_reason" class="form-control"
                                        placeholder="Enter English Reason"value="{{ old('en_reason', $reason->en_reason) }}">
                                    <input id="ar_name_input"type="text" name="ar_reason" class="form-control"
                                        placeholder="Enter Arabic Reason"value="{{ old('ar_reason', $reason->ar_reason) }}"
                                        style="display:none;">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="value_type"id="value_type_select">
                                        ...
                                        <option value="fixed"@if ($reason->value_type == 'fixed') selected @endif>Fixed
                                        </option>
                                        <option value="ratio"@if ($reason->value_type == 'ratio') selected @endif>Ratio
                                        </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="value" class="form-control" id="value_input"
                                        placeholder="Enter Value"value="{{ old('value', $reason->value) }}" step="0.01">
                                    @if ($errors->has('value'))
                                        <p class="text-error more-info-err" style="color: red;">

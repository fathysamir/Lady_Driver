                        ...
                        <div class="card-body">
                            <div>
                                ...
                                <form id="searchForm" class="search-bar"
                                    ...
                                    action="{{ route('users') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div id="filterOptions" style="display: none; text-align:center;">
                                        <div style="display: flex;">
                                            ...
                                            <select class="form-control"style="width: 33%;margin: 0% 1% 0% 1%;"
                                                name="role">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                              ...
                                              @else 
                                                  src="{{ asset('dashboard/user_avatar.png') }}" @endif
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ url('/admin-dashboard/user/edit/' . $user->id) }}"
                                    ...
                                    <span class="bi bi-trash" style="font-size: 1rem; color: rgb(255,255,255);"></span>
                                                        ...
                                                        <a
                                                            onclick='event.stopPropagation(); showConfirmationPopup("{{ url('/admin-dashboard/user/delete/' . $user->id) }}","{{ $user->name }}","{{ getFirstMediaUrl($user, $user->avatarCollection) ?? asset('dashboard/user_avatar.png') }}")'>

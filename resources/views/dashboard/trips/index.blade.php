                                    ...
                                    <div id="filterOptions" style="display: none; text-align:center;">
                                        ...
                                        <div style="display: flex; margin-top:10px;">
                                            ...
                                            <select class="form-control"
                                                style="width: 23.5%; margin: 0% 1% 0% 1%; display:none;"
                                            ...
                                            <div class="form-group"style="width: 23.5%; margin: 0% 0% 0% 1%;">
                                                <input type="date" name="created_date" class="form-control"
                                                    placeholder="Enter Created Date" style="width:100%;">
                                            ...
                                            @foreach ($all_trips as $trip)
                                                <tr onclick="window.location='{{ url('/admin-dashboard/trip/view/' . $trip->id) }}';"
                                                    ...
                                                    <td><span class="user-profile"><img
                                                                ...
                                                                class="img-circle" alt="user avatar"></span>
                                                        {{ $trip->car->owner->name }}</td>
                                                    <td>{{ $trip->car->mark->name }} - {{ $trip->car->model->name }}
                                                        ({{ $trip->car->year }})</td>
                                                    ...
                                                    <td>
                                                        ...
                                                        @elseif($trip->status == 'completed')
                                                            <span class="badge badge-secondary"
                                                                style="background-color:rgb(50, 134, 50);width:100%;">Completed</span>
                                                        @elseif($trip->status == 'in_progress')
                                                            <span class="badge badge-secondary"
                                                                style="background-color:rgb(52, 40, 223);width:100%;">In
                                                            Progress</span> @else<span class="badge badge-secondary"
                                                                style="background-color:rgb(255,0,0);width:100%;">Cancelled</span>
                                                        @endif
                                                    </td>

...
@section('title', 'Dashboard - create Motorcycle mark')
@section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="row mt-3">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">Create New Motorcycle Mark</div>
                            <hr>
                            <form method="post" action="{{ route('create.motorcycle') }}" enctype="multipart/form-data">
                                @csrf

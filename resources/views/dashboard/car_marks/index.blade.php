                    ...
                    <div class="card">
                      <div class="card-body">
                        <div style="display: flex;">
                            ...
                            <a  class="btn btn-light px-5" style="margin-bottom:1%; " href="{{route('add.car.mark')}}">create</a>
                            <form id="searchForm" class="search-bar" style="margin-bottom:1%;margin-left:20px;margin-right:0px;"method="post" action="{{ route('car-marks') }}" enctype="multipart/form-data">
                                @csrf
                            ...
                            <tr onclick="window.location='{{url('/admin-dashboard/car-mark/edit/'.$mark->id)}}';" style="cursor: pointer;">
                              <td>{!! highlight($mark->en_name, $search ?? '') !!} - {!! highlight($mark->ar_name, $search ?? '') !!}</td>
                                ...
                                <td>
                                  ...
                                  <a href="{{url('/admin-dashboard/car-mark/edit/'.$mark->id)}}" style="margin-right: 1rem;">
                                    <span  class="bi bi-pen" style="font-size: 1rem; color: rgb(255,255,255);"></span>
                                  </a>
                                 
                                  <a href="{{url('/admin-dashboard/car-mark/delete/'.$mark->id)}}">

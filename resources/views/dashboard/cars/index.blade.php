                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div style="text-align: center;">
                          {!! $all_cars->appends(['search' => request('search'),'user'=>request('user'),'status'=>request('status'),'mark'=>request('mark'),'model'=>request('model'),'year'=>request('year')])->links("pagination::bootstrap-4") !!}
                        </div>
                      </div>
                      </div>
                    </div>

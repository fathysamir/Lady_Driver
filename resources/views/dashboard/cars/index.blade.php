                    ...
                    <div class="card">
                      <div class="card-body">
                        <div>
                            ...
                            <form id="searchForm" class="search-bar" style="margin-bottom:1%;margin-right:20px;margin-left:0px;"method="post" action="{{ route('cars') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div id="filterOptions" style="display: none; text-align:center;">
                                  <div style="display: flex;">
                                    <select class="form-control" style="width: 18%; margin: 0% 1% 0% 0%;" name="user">
                                    ...
                                    <select class="form-control"style="width: 18%;margin: 0% 1% 0% 1%;" name="status">
                                    ...
                                    <select class="form-control" style="width: 18%; margin: 0% 1% 0% 1%;" name="mark"id="markSelect">
                                    ...
                                    <select class="form-control" style="width: 18%; margin: 0% 0% 0% 1%; display:none;" name="model"id="modelSelect">
                            ...
                            @foreach($all_cars as $car)
                              <tr>
                                ...
                                <td>
                                  ...
                                  <a href="{{url('/admin-dashboard/car/edit/'.$car->id)}}" style="margin-right: 1rem;">
                        ...
                        <div style="text-align: center;">
                          {!! $all_cars->appends(['search' => request('search'),'user'=>request('user'),'status'=>request('status'),'mark'=>request('mark'),'model'=>request('model'),'year'=>request('year'),'air_conditioned' => request('air_conditioned'),])->links("pagination::bootstrap-4") !!}
                        </div>
                      </div>
                      </div>
                    </div>

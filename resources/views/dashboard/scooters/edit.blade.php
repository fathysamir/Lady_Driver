                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('update.scooter', ['id' => $scooter->id]) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')

                                <div class="form-group" style="text-align: center;">
                                    <div style="display:inline-block;">
                                        <img id="preview-scooter-image"
                                             style="border-radius:2%; width:60%;"
                                             src="{{ $scooter->image ?? asset('dashboard/car_avatar.png') }}"
                                             onerror="this.onerror=null;this.src='{{ asset('dashboard/car_avatar.png') }}';"
                                             class="img-circle zoomable-image" alt="scooter image">
                                    </div>
                                ...
                                <div class="form-group">
                                    <label>License Expire Date :
                                        <span style="color: {{ \Carbon\Carbon::parse($scooter->license_expire_date)->isFuture() ? '#56ec60' : '#ff5f5f' }}">
                                ...
                                <div class="form-group" style="display:flex; align-items:flex-start; flex-wrap:wrap; gap:10px;">
                                    ...
                                    <div class="photo-edit-wrapper" id="wrapper-scooter-image">
                                        <img id="preview-scooter-image2"
                                        ...
                                        @if ($scooter->image)
                                            ...
                                            <button type="button" class="edit-photo-btn" title="Replace image"
                                                    onclick="document.getElementById('input-scooter-image').click()">✎</button>
                                            <input type="file" id="input-scooter-image" name="scooter_image" accept="image/*"
                                                   style="display:none" data-wrapper="wrapper-scooter-image" data-preview="preview-scooter-image2">
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="form-group" style="display:flex; align-items:flex-start; flex-wrap:wrap; gap:10px;">
                                    ...
                                    <div class="photo-edit-wrapper" id="wrapper-plate-image">
                                        <img id="preview-plate-image"
                                             style="margin:0 10px; border-radius:10px; width:300px;"
                                             src="{{ $scooter->plate_image }}"
                                             onerror="this.onerror=null;this.src='{{ asset('dashboard/image_placeholder.png') }}';"
                                             class="zoomable-image">
                                        @if ($scooter->plate_image)
                                            <span class="new-img-badge">NEW</span>
                                            <button type="button" class="edit-photo-btn" title="Replace image"
                                ...
                                <div class="form-group" style="display:flex; align-items:flex-start; flex-wrap:wrap; gap:10px;">
                                    ...
                                    <div class="photo-edit-wrapper" id="wrapper-lic-front">
                                        <img id="preview-lic-front"
                                             style="margin:0 10px; border-radius:10px; width:300px;"
                                             src="{{ $scooter->license_front_image }}"
                                             onerror="this.onerror=null;this.src='{{ asset('dashboard/image_placeholder.png') }}';"
                                             class="zoomable-image">
                                        @if ($scooter->license_front_image)
                                            <span class="new-img-badge">NEW</span>
                                            <button type="button" class="edit-photo-btn" title="Replace image"
                                ...
                                <div class="form-group" style="display:flex; align-items:flex-start; flex-wrap:wrap; gap:10px;">
                                    ...
                                    <div class="photo-edit-wrapper" id="wrapper-lic-back">
                                        <img id="preview-lic-back"
                                             style="margin:0 10px; border-radius:10px; width:300px;"
                                             src="{{ $scooter->license_back_image }}"
                                             onerror="this.onerror=null;this.src='{{ asset('dashboard/image_placeholder.png') }}';"
                                             class="zoomable-image">
                                        @if ($scooter->license_back_image)
                                            <span class="new-img-badge">NEW</span>
                                            <button type="button" class="edit-photo-btn" title="Replace image"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="status">
                                        <option value="pending"   @if ($scooter->status == 'pending')   selected @endif>Pending</option>
                                        <option value="confirmed" @if ($scooter->status == 'confirmed') selected @endif>Confirmed</option>
                                        <option value="blocked"   @if ($scooter->status == 'blocked')   selected @endif>Blocked</option>
                                    </select>
                                </div>
            ...
            document.querySelectorAll('input[type="file"][data-preview]').forEach(function (input) {
                input.addEventListener('change', function () {
                    ...
                    reader.onload = function (e) {
                        ...
                        if (input.name === 'scooter_image') {
                            var topImg = document.getElementById('preview-scooter-image');

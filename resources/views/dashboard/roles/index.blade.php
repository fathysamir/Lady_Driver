                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                            ...
                                            @foreach ($roles as $role)
                                                <tr onclick="window.location='{{ route('roles.edit', ['id' => $role->id] + request()->query()) }}';"
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('roles.edit', ['id' => $role->id] + request()->query()) }}"
                                    ...
                                    <span class="bi bi-trash" style="font-size: 1rem; color: rgb(255,255,255);"></span>
                                                        ...
                                                        <a
                                                            onclick='event.stopPropagation(); showConfirmationPopup("{{ url('/admin-dashboard/roles/delete/' . $role->id) }}","{{ $role->name }}")'>

                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <form method="post" action="{{ route('update.car.model', $model->id) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="en_name_input" type="text" name="en_name" class="form-control"
                                        placeholder="Enter English Name"value="{{ old('en_name', $model->en_name) }}">
                                    <input id="ar_name_input"type="text" name="ar_name" class="form-control"
                                        placeholder="Enter Arabic Name"value="{{ old('ar_name', $model->ar_name) }}"
                                        style="display:none;">
                                    ...
                                    <select class="form-control" name="car_mark">
                                        ...
                                        @foreach ($marks as $mark)
                                            <option value="{{ $mark->id }}"
                                                @if ($model->car_mark_id == $mark->id) selected @endif>{{ $mark->en_name }} -
                                                {{ $mark->ar_name }}</option>
                                        @endforeach
                                    </select>

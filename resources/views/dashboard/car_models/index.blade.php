                        ...
                        <div class="card-body">
                            <div>
                                ...
                                <form id="searchForm" class="search-bar"
                                    ...
                                    action="{{ route('car-models') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div style="display:flex;">
                                        ...
                                        <div style="display:flex;margin-bottom:1%;margin-left:0px;">
                                            <a class="btn btn-light px-5" style="margin-bottom:1%; "
                                                href="{{ route('add.car.model') }}">create</a>
                                    ...
                                    <tbody>
                                        @if (!empty($all_models) && $all_models->count())
                                            @foreach ($all_models as $model)
                                                <tr onclick="window.location='{{ url('/admin-dashboard/car-model/edit/' . $model->id) }}';"
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ url('/admin-dashboard/car-model/edit/' . $model->id) }}"
                                                        ...
                                                        <a
                                                            href="{{ url('/admin-dashboard/car-model/delete/' . $model->id) }}">

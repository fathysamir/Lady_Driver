...
@section('title', 'Dashboard - create car model')
@section('content')	
        ...
        <div class="container-fluid">
            ...
            <div class="row mt-3">
                <div class="col-lg-12">
                    <div class="card">
                      <div class="card-body">
                      <div class="card-title">Create New Car Model</div>
                      <hr>
                       <form method="post" action="{{route('create.car.model')}}" enctype="multipart/form-data">
                        @csrf
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="car_mark">
                          ...
                          <option value="{{$mark->id}}" @if(old('car_mark')==$mark->id) selected @endif>{{$mark->en_name}} - {{$mark->ar_name}}</option>
                          @endforeach
                        </select>

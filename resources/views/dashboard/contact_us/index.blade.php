                                    ...
                                    <tbody>
                                        @if (!empty($all_contact_us) && $all_contact_us->count())
                                            @foreach ($all_contact_us as $contact_us)
                                                <tr onclick="window.location='{{ url('/admin-dashboard/contact_us/view/' . $contact_us->id) }}';"
                                                    style="cursor: pointer;">
                                                    <td>
                                                        @if ($contact_us->seen == '0')
                                                            <span class="badge badge-secondary"
                                                                style="background-color:rgb(50, 134, 50);width:100%;">New</span>
                                                        @endif
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ url('/admin-dashboard/contact_us/view/' . $contact_us->id) }}"

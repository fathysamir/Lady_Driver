    ...
    public function create_car(Request $request){
        ...
        $validator  =   Validator::make($request->all(), [
           'car_mark_id' => [
            ...
            'plate_image' => 'required|image|mimes:jpeg,png,jpg,gif', 
            'license_front_image' => 'required|image|mimes:jpeg,png,jpg,gif', 
            'license_back_image' => 'required|image|mimes:jpeg,png,jpg,gif',
            'lat' => 'nullable',
            'lng' => 'nullable',
    ...
    public function edit_car(Request $request){
        ...
        $validator  =   Validator::make($request->all(), [
            ...
            'car_mark_id' => [
             ...
             'plate_image' => 'nullable|image|mimes:jpeg,png,jpg,gif', 
             'license_front_image' => 'nullable|image|mimes:jpeg,png,jpg,gif', 
             'license_back_image' => 'nullable|image|mimes:jpeg,png,jpg,gif',
             'lat' => 'nullable',
             'lng' => 'nullable',
             'license_expire_date'=>'required|date',
             'passenger_type'=>'required|in:female,male_female'

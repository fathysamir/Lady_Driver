...
class ClientController extends ApiController
{
    ...
    public function current_trip()
    {
        ...
        $trip = Trip::where('user_id', auth()->user()->id)->whereIn('status', ['created', 'pending', 'in_progress'])->with(['car' => function ($query) {
            $query->select('id','user_id','car_mark_id','car_model_id','year','lat','lng')->with(['mark:id,en_name,ar_name', 'model:id,en_name,ar_name', 'owner:id,name,country_code,phone,level']);
        }, 'scooter' => function ($query) {
            $query->select('id','user_id','motorcycle_mark_id','motorcycle_model_id','year','lat','lng')->with(['mark:id,en_name,ar_name', 'model:id,en_name,ar_name', 'owner:id,name,country_code,phone,level']);

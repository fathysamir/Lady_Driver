...
class TripTrackingService
{
    public function calculate($lat, $lng, $trip)
    {
        ...
        $messages = [
            ...
            'ar' => [
                '500'     => 'السائقة على بعد 500 متر',
                '400'     => 'السائقة على بعد 400 متر',
                '300'     => 'السائقة على بعد 300 متر',
                '200'     => 'السائقة على بعد 200 متر',
                '100'     => 'السائقة على بعد 100 متر',
                'arrived' => 'وصلت السائقة',
                'far'     => 'السائقة في الطريق',      // ← add a fallback key
            ]
        ];
